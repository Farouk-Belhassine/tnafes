...
public class ajoutcoachcontroller {
  ...
  @FXML
    ...
    @FXML
     private void ajoutercoach(ActionEvent event) {
        ...
        float fsal = Float.parseFloat(tfsalaire.getText());//float to int
        coach a = new coach(tfnom.getText(),tfprenom.getText(),tfemail.getText(),inum,tfpassword.getText(),cbrole.getValue().toString(),fsal);
