 ...
 * @author HP
 */
public class MenuArtController implements Initializable {
    ...
    @FXML
    private void changeajoutAr(ActionEvent event) throws IOException {
         Parent gestionView = FXMLLoader.load(getClass().getResource("../GUI/AjoutArticle.fxml"));
    ...
    @FXML
    private void changeaffichageAr(ActionEvent event) throws IOException {
          Parent gestionView = FXMLLoader.load(getClass().getResource("../GUI/afficherAr.fxml"));
     Scene gestionViewScene = new Scene(gestionView);
