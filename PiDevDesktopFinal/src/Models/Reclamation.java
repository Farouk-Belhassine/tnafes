...
//ajout
    public Reclamation(user user ,String message,String objet) {
  
        this.id =user;
//        this.nom_user =id.getNom();
//        this.prenom_user =id.getPrenom();
...
//update
    public Reclamation(int id_reclamation,String nom_user, String prenom_user,String num, String email, String message,String objet, String etat) {
...
//display
    public Reclamation(int id,String nom_user, String prenom_user, String num,String email, String message,String objet,String etat,Date date,Date date2) {
