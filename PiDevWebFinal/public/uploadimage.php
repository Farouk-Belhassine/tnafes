...
if ((($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image/jpg") || ($_FILES["file"]["type"] == "image/pjpeg") || ($_FILES["file"]["type"] == "image/x-png") || ($_FILES["file"]["type"] == "image/png"))	) {
    if ($_FILES["file"]["error"] > 0) {
        ...
        copy($_FILES["file"]["tmp_name"], "C:/Users/miral/OneDrive/Bureau/ESPRIT/3A6/SEM2/PiDevWebFinal/public/uploads/images/posts/". $_FILES["file"]["name"]);
        move_uploaded_file($_FILES["file"]["tmp_name"], "C:/Users/miral/OneDrive/Bureau/ESPRIT/3A6/SEM2/PiDevMobile/src/images/" . $_FILES["file"]["name"]);
